<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"C:\phpStudy\PHPTutorial\WWW\TP5\public/../application/admin\view\index.html";i:1524538914;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">&copy; 2016-2017 <?php echo $web_name; ?> 版权所有
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
