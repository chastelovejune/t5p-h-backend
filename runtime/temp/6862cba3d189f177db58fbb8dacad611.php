<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"C:\phpStudy\PHPTutorial\WWW\xianrenzhang\public/../application/admin\view\index\index.html";i:1490687885;s:92:"C:\phpStudy\PHPTutorial\WWW\xianrenzhang\public/../application/admin\view\public\header.html";i:1490249850;s:92:"C:\phpStudy\PHPTutorial\WWW\xianrenzhang\public/../application/admin\view\public\footer.html";i:1490249850;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper wrapper-content">
    ...
    <div class="row ">
        <div class="col-sm-12 ">
            <div class="col-sm-6 animated lightSpeedIn">
            ...
            <div class="col-sm-6 animated rollIn">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <i class="fa fa-cogs "></i> 系统信息
                    </div>
                    <div class="panel-body">
                        <p><i class="fa fa-send-o"></i> QQ：605780722
                        </p>
...
$(function(){
   // $('#p').addClass('animated bounce');
    ...
    $('#weather').leoweather({format:'，{时段}好！<span id="colock">现在时间是：<strong>{年}年{月}月{日}日 星期{周} {时}:{分}:{秒}</strong>，</span> {天气} {夜间气温}℃ ~ {白天气温}℃'});
</script>
