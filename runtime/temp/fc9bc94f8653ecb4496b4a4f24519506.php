<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"C:\phpStudy\PHPTutorial\WWW\xianrenzhang\public/../application/admin\view\login.html";i:1491036554;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-sm-7" style="color:#fff">
            <div class="signin-info">
                ...
                <div class="m-b"></div>
                <h4>欢迎使用 <strong>残剑后台管理</strong></h4>
                <ul class="m-b">
                    <p class="m-t-md">CMS系统后台</p>
                    <p class="m-t-md">企业站后台</p>
                    <p class="m-t-md">商城后台..</p>
                    <p class="m-t-md">各种系统通用后台</p>
                </ul>
            </div>
        </div>
